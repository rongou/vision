...
def main(args):
    ...
    model = torchvision.models.get_model(
        ...
        norm_layer=dynorm.get_norm_layer(
            args.norm_type, init_alpha=args.init_alpha, alpha_noise_std=args.alpha_noise_std
        ),
    ...
    if args.lr_scheduler == "steplr":
        ...
        step_scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=args.lr_step_size, gamma=args.lr_gamma)
        main_lr_scheduler = torch.optim.lr_scheduler.ChainedScheduler([cosine_scheduler, step_scheduler])
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--alpha-noise-std", default=0.0, type=float, help="Standard deviation of alpha noise")
    parser.add_argument(
        "--no-use-relu",
        dest="use_relu",
        action="store_false",
